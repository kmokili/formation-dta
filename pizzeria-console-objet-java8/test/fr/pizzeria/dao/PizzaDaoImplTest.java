...
public class PizzaDaoImplTest {
	...
	public void setUp() throws Exception {
		...
		listePizzaInitiales.add(new Pizza("PEP", "Pépéroni", 12.50, CategoriePizza.VIANDE));
		listePizzaInitiales.add(new Pizza("MAR", "Margherita", 14.00,  CategoriePizza.SANS_VIANDE));
		listePizzaInitiales.add(new Pizza("REI", "La Reine", 11.50, CategoriePizza.VIANDE));
		listePizzaInitiales.add(new Pizza("FRO", "La 4 fromages", 12.00,  CategoriePizza.SANS_VIANDE));
		listePizzaInitiales.add(new Pizza("CAN", "La cannibale", 12.50, CategoriePizza.VIANDE));
		listePizzaInitiales.add(new Pizza("SAV", "La savoyarde", 13.00, CategoriePizza.VIANDE));
		listePizzaInitiales.add(new Pizza("ORI", "L'orientale", 13.50, CategoriePizza.VIANDE));
		listePizzaInitiales.add(new Pizza("IND", "L'indienne", 14.00, CategoriePizza.VIANDE));
		listePizzaInitiales.add(new Pizza("SAU", "La Saumonéta", 14.00, CategoriePizza.POISSON));
